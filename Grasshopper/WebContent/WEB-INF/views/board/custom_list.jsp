...
<body>
	...
	<div class="wrap">
		<div class="intro_bg2" style="width: 100%; height: 225px; background-position: top; background-positoin: center; background-repeat: no-repeat; background-image: url('/resources/img/cocktailbar.jpg');">
			<div class="header">
	...
	<div class="search-bar">
		<form name="searchForm" action="/custom/list" method="get">
			<select id="category" name="category" value="${category }">
				...
				autocomplete="off" id="search" onkeyup="searchFunction()"
				placeholder="검색어를 입력하세요"> <input type="submit"
				id="btnSearch" value="찾기">
		</form>
	</div>
			...
			<c:forEach var="c" items="${list }">
				<div class="card">
					<div class="card_image" id="card_thumbnail${c.custom_board_no })">
						<img src="/upload/${c.custom_board_attachment }"
					...
					<div class="card_info">
						<div class="card_viewcount">
							<span class="material-icons">visibility</span><a
								style="margin-left: 5px;">${c.custom_board_hit }</a>
						</div>
						<div>
							<a class="card_link"
